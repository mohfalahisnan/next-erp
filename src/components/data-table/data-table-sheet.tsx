		...
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				className={cn(
					...
					side === "right" &&
						"data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 top-4 bottom-4 right-4 rounded-xl h-[calc(100% - 88px)] w-3/4 border sm:max-w-xl",
					side === "left" &&
